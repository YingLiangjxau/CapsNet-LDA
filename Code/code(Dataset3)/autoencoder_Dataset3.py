...
ReadMyCsv(PositiveSampleFeature, "PDCSLCS(Dataset3).csv")
NegativeSampleFeature = []
ReadMyCsv(NegativeSampleFeature, "NDCSLCS(Dataset3).csv")
...
decoded = Dense(958, activation='sigmoid')(encoded)
...
storFile(encoded_data_pre, 'DCSLCS(Dataset3)(64dim).csv')

# Similarly, get 'DGSLGS(Dataset3)(64dim).csv' and 'DSSLFS(Dataset3)(64dim).csv'
