...
ReadMyCsv(PositiveSampleFeature, "PDCSLCS(Dataset2).csv")
NegativeSampleFeature = []
ReadMyCsv(NegativeSampleFeature, "NDCSLCS(Dataset2).csv")
...
decoded = Dense(652, activation='sigmoid')(encoded)
...
storFile(encoded_data_pre, 'DCSLCS(Dataset2)(64dim).csv')

# Similarly, get 'DGSLGS(Dataset2)(64dim).csv' and 'DSSLFS(Dataset2)(64dim).csv'
